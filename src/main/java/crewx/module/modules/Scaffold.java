...
public class Scaffold extends Module {
    ...
    private boolean isKaizenServer() {
        try {
            return mc.getCurrentServerData() != null
                    ...
                    && mc.getCurrentServerData().serverIP.toLowerCase().contains("kaizen");
        }
    ...
    private void enforceKaizenMultiplaceFlag() {
        if (this.isKaizenServer()) {
            if (this.multiplace.getValue()) {
                this.multiplace.setValue(false);
                if (!this.kaizenMultiplaceNotified) {
                    Notifications.pushRaw("Scaffold", "Multiplace desativado pq da flag no kaizen");
                    this.kaizenMultiplaceNotified = true;
                }
            }
        }
        else {
            this.kaizenMultiplaceNotified = false;
        }
    }
