...
import crewx.mixin.IAccessorC0DPacketCloseWindow;
...
public class InvWalk extends Module {
    ...
    public void pressMovementKeys(boolean skipSneak) {
        ...
        if (CrewX.moduleManager.modules.get(Sprint.class).isEnabled()) {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (mc.currentScreen instanceof crewx.gui.ClickGui && this.guiEnabled.getValue()) {
