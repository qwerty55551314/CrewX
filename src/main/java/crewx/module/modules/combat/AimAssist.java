...
public class AimAssist extends Module {
    ...
    private boolean isValidTarget(EntityPlayer entityPlayer) {
        if (entityPlayer != mc.thePlayer && entityPlayer != mc.thePlayer.ridingEntity) {
            if (entityPlayer == mc.getRenderViewEntity() || entityPlayer == mc.getRenderViewEntity().ridingEntity) {
                ...
                crewx.module.modules.misc.AntiBot antiBot = (crewx.module.modules.misc.AntiBot) CrewX.moduleManager.modules.get(crewx.module.modules.misc.AntiBot.class);
    ...
    private boolean isInReach(EntityPlayer entityPlayer) {
        Reach reach = (Reach) CrewX.moduleManager.modules.get(Reach.class);
    ...
    public void onPress(KeyEvent event) {
        if (event.getKey() == mc.gameSettings.keyBindAttack.getKeyCode() && !CrewX.moduleManager.modules.get(AutoClicker.class).isEnabled()) {
            this.timer.reset();
        }
    }
}